...
public class Footer extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//out.append("            &copy; Copyright <strong><span>JP302</span></strong>. All Rights Reserved");
		//out.append("        </div>");
		...
		out.append("    <script src=\"/adv/adjs/apexcharts/apexcharts.min.js?1500\"></script>");

		out.append("    <!-- Template Main JS File -->");
		//out.append("    <script src=\"/adv/adjs/bootstrap.bundle.min.js?1500\"></script>");//them
		out.append("    <script type=\"text/javascript\" src=\"/adv/adjs/main.js\"></script>");
